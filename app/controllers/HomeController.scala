...
class HomeController @Inject()(computerService: ComputerRepository,
  ...
  /**
    * This result directry redirect to the application home.
    */
  val Home = Redirect(routes.HomeController.list(0, 2, ""))

  /**
    * Describe the computer form (used is both edit and create screens).
    */
  ...
  /**
    * Handle defautl path requests, redirect to computers list
    */
  def index = Action {
    Home
  }
